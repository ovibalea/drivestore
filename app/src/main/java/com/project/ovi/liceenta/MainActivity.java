...
import com.project.ovi.liceenta.service.RootFolderService;
...
//        Intent intent = new Intent(this, ListOjectsFromRootActivity.class);
//        startActivityForResult(intent, BaseManagerActivity.REQUEST_CODE_RESOLUTION);


        mProgress = new ProgressDialog(this);
        mProgress.setMessage("Request in progress ...");
    ...
    private void setContentItems() {
        try {
            RootFolderService folderService = new RootFolderService();
            List<DriveItem> driveItems = folderService.getRootFolderItems();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == BaseManagerActivity.REQUEST_CODE_RESOLUTION && resultCode == RESULT_OK) {
            ArrayList<DriveItem> driveItems = (ArrayList<DriveItem>) data.getExtras().get(ListOjectsFromRootActivity.DRIVE_ITEMS_RESULT_TAG);
            DriveItemsViewAdapter driveItemsViewAdapter = new DriveItemsViewAdapter(driveItems);
            RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recyclerview);
            recyclerView.setAdapter(driveItemsViewAdapter);
            recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
    ...
    private void setFabMenuActions() {
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), CreateEmptyFileActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
    ...
    private void chooseAccount() {
        if (EasyPermissions.hasPermissions(
            ...
            if (accountName != null) {
                ...
                getResultsFromApi();
                Log.i("Main activity", "reguest get from api");
            } else {
                // Start a dialog from which the user can choose an account
                Log.i("Main activity", "start else");
